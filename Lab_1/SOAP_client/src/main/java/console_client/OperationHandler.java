...
public class OperationHandler {
    ...
    public void selectQuery(){
        Query query = inputReader.readSearchInput();
    ...
    public void insertQuery(){
        Query query = inputReader.readInsertInput();
    ...
    public void updateQuery(){
        Query from = inputReader.readSearchInput();
        System.out.println("Insert updated information");
        Query to = inputReader.readInsertInput();
