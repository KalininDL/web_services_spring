...
public class MariaDBDAO {
    ...
    private static class MariaDBDAOSingletonHoolder{
        public static final MariaDBDAO instance = new MariaDBDAO();
    }

    public static MariaDBDAO getInstance(){
        return MariaDBDAO.MariaDBDAOSingletonHoolder.instance;
    }
